 ...
 */
	...
	public ResponseEntity<?> updateJugador(@RequestBody Jugador j, @PathVariable("id") Integer id)
...
//	public ResponseEntity<?> deleteJugador(@PathVariable Integer id) throws EntityNoEncontradaException {
...
//				throw new EntityNoEncontradaException("No se encontró ninguna entidad con el ID " + id);
//			}
//			respuesta.put("Borrado ", jugador);
//			jugadorServiceImpl.borrarJugador(id);
//			return new ResponseEntity<Map<String, Object>>(respuesta, HttpStatus.OK);
//		} catch (EntityNoEncontradaException e) {
//			respuesta.put(e.getMessage(), "Error al buscar la entidad");
...
//	}
	...
	@Operation(summary = "jugador", description = "Lista los  todos los jugadores y sus datos ", tags = { "jugadorController" })
	...
	public JugadorDTO getEntity(@PathVariable("id") Integer entityId) {
	...
	@Operation(summary = "jugador", description = "devuelve al jugador/a con peor porcentaje de éxito", tags = { "jugadorController" })
	...
	@Operation(summary = "jugador", description = "devuelve al jugador/a con mejor  porcentaje de éxito", tags = { "jugadorController" })
