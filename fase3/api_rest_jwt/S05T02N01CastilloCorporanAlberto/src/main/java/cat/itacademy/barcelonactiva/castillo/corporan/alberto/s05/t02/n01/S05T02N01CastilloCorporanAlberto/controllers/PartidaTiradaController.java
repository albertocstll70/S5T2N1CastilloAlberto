...
public class PartidaTiradaController {
	...
	public ResponseEntity<?> crearPartida(@PathVariable("id") String idJugador) {
		...
		if (jugador != null) {
			...
			TiradaDTO tDTO = partidaServiceImpl.crearPartidaTirada(partida, tirada);
			return new ResponseEntity<TiradaDTO>(tDTO, HttpStatus.CREATED);
		} else {
	...
	public ResponseEntity<?> borrarTirada(@PathVariable("id") String idJugador) {
	...
	public ResponseEntity<?> listarJugadas(@PathVariable("id") String idJugador) {
